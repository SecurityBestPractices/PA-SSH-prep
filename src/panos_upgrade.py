...
# PAN-OS upgrade paths - maps source major version to next version in upgrade path
# Format: {source_major: next_version}
UPGRADE_PATHS = {
    "9.0": "9.1.0",
    "9.1": "10.0.0",
    "10.0": "10.1.0",
...
# Available target versions (update as new versions release)
TARGET_VERSIONS = [
    "11.2.4",
    "11.2.3",
    "11.2.2",
